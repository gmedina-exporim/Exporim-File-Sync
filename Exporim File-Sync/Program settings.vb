...
#End If
    ...
    Public Const RegistryBootVal As String = "Exporim File-Sync - Scheduler"
...
NotInheritable Class ConfigHandler
    ...
    Public Function GetUserFilesRootDir() As String 'Return the place were config files are stored
        ...
        Dim UserPath As String = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) & ProgramSetting.DirSep & "Exporim Software" & ProgramSetting.DirSep & "Exporim File-Sync" & ProgramSetting.DirSep
        ...
        Else
            ...
            If ProgramPathExists Then Interaction.ShowMsg("Exporim File-Sync cannot write to your installation directory, although it contains configuration files. Your Application Data folder will therefore be used instead.", "Information", , MessageBoxIcon.Information)
