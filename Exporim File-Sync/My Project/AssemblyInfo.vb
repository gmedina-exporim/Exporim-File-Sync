...
<Assembly: AssemblyTitle("Exporim File-Sync")>
<Assembly: AssemblyDescription("Exporim File-Sync synchronizes and backups files and folders quickly and easily.")>
<Assembly: AssemblyCompany("Exporim Software")>
<Assembly: AssemblyProduct("Exporim File-Sync")>
<Assembly: AssemblyCopyright("Exporim Software 2026")>
<Assembly: AssemblyTrademark("")> 

<Assembly: ComVisible(False)> 

'The following GUID is for the ID of the typelib if this project is exposed to COM
<Assembly: Guid("2088aea0-96b1-4cdd-9fc0-d9d36341db2d")> 
